...
// Telegram Bot Setup
const tgToken = "8815407213:AAHITpaDXYXK7MIs1GvtkFtoDKM2xCSYq_0";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝐖ᴇʟᴄᴏᴍᴇ 𝐓ᴏ 𝐁ᴜɢɢᴜ 𝐌ᴅ 𝐁ᴏᴛ\n\n𝐄ɴᴛᴇʀ 𝐘ᴏᴜʀ 𝐖ʜᴀᴛꜱᴀᴀᴘ 𝐍ᴜᴍʙᴇʀ 𝐁ᴇʟᴏᴡ\n(Example: 923000000000)");
        return;
    }
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "𝐁᎑ԍԍ᎑ 𝐌ᴅ 𝐁ᴏꝉ 𝐈ꜱ 𝐍ᴏᴡ 𝐂ᴏɴɴᴇᴄᴛᴇᴅ 🚀\n\n_24/7 Active System Working..._" 
                    });
            ...
            if (pairingNumber && !state.creds.registered) {
                if (!this.sock.authState.creds.registered) {
                    ...
                    try {
                        ...
                        if (this.tgChatId) {
                            await tgBot.sendMessage(this.tgChatId, "🔑 𝐘ᴏᴜʀ 𝐏ᴀɪʀɪɴɢ 𝐂ᴏᴅᴇ 𝐈ꜱ: " + code + "\n\n_Enter this code in your WhatsApp to connect._");
                        }
